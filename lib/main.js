...
import docusaurus from './languages/docusaurus/index.js';
import gatsby from './languages/gatsby/index.js';
import js from './languages/js/index.js';
import mkdocs from './languages/mkdocs/index.js';
import py from './languages/py/index.js';
import rb from './languages/rb/index.js';


const debug = _debug('client-gen');
const GENERATORS = {
  docusaurus,
  gatsby,
  js,
...
const resolveSchemaRefs = (api, refs) => {
  ...
  refs.forEach((ref) => {
    ...
    const outSchema = { $schema: 'http://json-schema.org/draft-07/schema#', ...schema };
...
export default async (options) => {
  ...
  await GENERATORS[options.lang](apiDef, options);
};
